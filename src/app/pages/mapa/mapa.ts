  ...
  template: `
    <div class="mapa-wrapper">
      <div class="texto-introductorio">
        <h2>Explora el Archipiélago</h2>
        <p>
          Las Islas Galápagos son un paraíso de biodiversidad y cultura. 
          Navega por nuestro mapa interactivo y selecciona cualquiera de las islas principales 
          para descubrir sus costumbres, gastronomía local, fauna endémica y las normativas 
          necesarias para proteger su ecosistema durante tu visita.
        </p>
      </div>
          ...
          <div class="modal-body">
            ...
            <div class="seccion" *ngIf="islaSeleccionada.costumbres.length > 0">
              ...
              <ul class="lista-costumbres">
                <li *ngFor="let costumbre of islaSeleccionada.costumbres">{{ costumbre }}</li>
              </ul>
            </div>
...
export class MapaComponent implements AfterViewInit {
  ...
  private inicializarMapa(): void {
    ...
    const puntosDeInteres: InfoIsla[] = [
      { 
        nombre: 'Santa Cruz', 
        lat: -0.6301, 
        lng: -90.3638, 
      ...
      { 
        ...
        comida: [], // Sin comida típica porque no hay población civil
  ...
  private configurarIconosLeaflet(): void {
    const iconRetinaUrl = 'assets/icons/map-marker-svgrepo-com.svg';
const iconUrl = 'assets/icons/map-marker-svgrepo-com.svg';
//const shadowUrl = 'assets/icons/map-marker-svgrepo-com.svg';
